* Install packages
  ...
  - wanderlust :: Email
  - worf :: vi-like keybindings for org-mode
     ...
     (setq org-capture-templates
           '(
             ...
             ("c" "Calendar" entry (file+datetree "~/org/calendar.org")
              "** %? \n\n   %i")
             ("e" "Contacts" entry (file "~/org/contacts.org")
...
* Evil
  ...
  Some modes should start in insert state

  #+begin_src emacs-lisp
    (evil-set-initial-state 'org-capture-mode 'insert)
    ;; (defun fu-emacs-state-mode ()
    ;;   (when evil-mode (evil-initial-state 'emacs)))
    ;; (add-hook 'wl-folder-mode-hook 'fu-emacs-state-mode)
    ;; (add-hook 'wl-summary-mode-hook 'fu-emacs-state-mode)
  #+end_src
...
* Wanderlust
  ...
  #+begin_src emacs-lisp
    ...
    (require 'org-wl)
    ;; IMAP
    (setq elmo-imap4-default-server "mail.his.se"
          elmo-imap4-default-user "sjoi"
    ...
    ;; SMTP
    (setq smtpmail-default-smtp-server "mail.his.se"
          smtpmail-local-domain "HS"
          send-mail-function 'smtpmail-send-it
          smtpmail-smtp-server "mail.his.se"
    ...
    (setq wl-smtp-connection-type 'ssl
          ...
          wl-smtp-posting-user "sjoi"
          wl-smtp-posting-server "mail.his.se"
          wl-smtp-authenticate-type "login"
          wl-message-id-domain "HS"
          wl-local-domain "HS"
          )

    ;; Other stuff
    (setq wl-from "Erik Sjöstrand <erik.sjostrand@his.se>"
          wl-default-folder "%inbox"
          wl-draft-folder "%[his]/Drafts"
          wl-trash-folder "%[his]/Trash"
          wl-fcc "%[his]/Sent"
    ...
    ;; reply to all should not be default
    ...
    (add-hook 'wl-folder-mode-hook 'evil-insert-state)
    (add-hook 'wl-summary-mode-hook 'evil-insert-state)
  #+end_src
...
** TODO Multiple cursors
   ...
   Det här borde flyttas till Hydra eller §.
...
** TODO § leader key
   ...
   Koden för Windowsregister verkar ha försvunnit.

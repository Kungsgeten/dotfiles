* Install packages
  ...
  - aggressive-indent :: What it sounds like
  - anzu :: Show number of matches in modeline while searching
  - darkroom :: Focus on writing
  ...
  - hydra :: "Modal" keybindings
  - helm :: Completion and stuff
  - htmlize :: Convert buffer to html
  - jedi :: Completion for Python
  - lispy :: Gör saker innan paranteser i Lisp
  - neotree :: Få upp ett filträd
  - org-cliplink :: Klistra in weblänk i org-fil
  - org-download :: Dra bilder in i org-mode
  - org-projectile :: TODO för projekt
  ...
  #+begin_src emacs-lisp
    ...
    (defvar my-packages '(ace-jump-mode ace-window
                                        ...
                                        neotree
                                        openwith
                                        org-download org-cliplink org-projectile
                                        ox-reveal
                                        projectile
                                        pydoc-info
                                        skewer-mode
...
* Helm
  ...
  #+begin_src emacs-lisp
    ...
    ;; http://slumpy.org/blog/2014/05/03/disabling-helm-mode-for-org-mode-org-set-tags-in-emacs/
...
* Programming
  ...
  Aggressive indent is used in some modes
...
* Evil
  ...
  Jag vill kunna använda vissa Emacs-kommandon även i normal-mode:
...
** § leader key
   ...
   #+begin_src emacs-lisp
     ...
     (defun ess/window-configuration-set-or-load (char)
       "Loads the char windowconf, or sets the register to current windowconf if there is none."
       (if (assoc char register-alist)
     ...
     (mapc
      ...
      '(
        ...
        ("1" . (lambda () (interactive) (ess/window-configuration-set-or-load ?1)))
        ("2" . (lambda () (interactive) (ess/window-configuration-set-or-load ?2)))
        ("3" . (lambda () (interactive) (ess/window-configuration-set-or-load ?3)))
        ("4" . (lambda () (interactive) (ess/window-configuration-set-or-load ?4)))
        ("5" . (lambda () (interactive) (ess/window-configuration-set-or-load ?5)))
        ("6" . (lambda () (interactive) (ess/window-configuration-set-or-load ?6)))
        ("7" . (lambda () (interactive) (ess/window-configuration-set-or-load ?7)))
        ("8" . (lambda () (interactive) (ess/window-configuration-set-or-load ?8)))
        ("9" . (lambda () (interactive) (ess/window-configuration-set-or-load ?9)))
        ("0" . (lambda () (interactive) (ess/window-configuration-set-or-load ?0)))
